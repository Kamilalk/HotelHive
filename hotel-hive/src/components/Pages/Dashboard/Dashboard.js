          ...
          <div className="col-lg-8 col-md-8 col-sm-6 hexagon-links-container">
            <div className="image-cont-1">
              <div className="image-container">
                ...
                <Link to={`/myprofile/${userId}`} className="profile-link">My Profile</Link>
              ...
              <div className="roaster-image-container">
                ...
                <Link to="/Roster" className="roaster-link">Roster</Link>
                <img src={image} alt="img" />
              </div>
              <div className="staff-image-container">
                ...
                <Link to="/StaffProfiles" className="staff-link">Staff Profile</Link>
                <img src={image} alt="img" />
              </div>
            </div>
            ...
            <div className="image-cont-2">
              ...
              <div className="image-container">
               <svg className="room-assignments-image" width="24" height="30" viewBox="0 0 24 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {(role === 'porter' || role === 'Handyman') ? (
                    <Link to="/" className="room-assignments-link">Room Assignments</Link>
                  ) : (
                    <Link to="RoomAssignments" className="room-assignments-link">Room Assignments</Link>
                  )}
            ...
            <div className="image-cont-3">
              <div className="image-container">
                ...
                <Link to="/RoomProfiles" className="room-profiles-link">Room Profiles</Link>
                <img src={image} alt="img" />
              </div>
              <div className="training-image-container">
                ...
                <Link to="/TrainingMode" className="training-mode-link">Training Mode</Link>
                <img src={image} alt="img" />
              </div>
            </div>
            ...
            <div className="image-cont-4">
              <div className="image-container">
                ...
                {(role === 'Supervisor' || role === 'Manager') ? (
                    <Link to="/MyTasks" className="my-tasks-link">My Tasks</Link>
                  ) : (
                    <Link to="/mytasksstaff" className="my-tasks-link">My Tasks</Link>
                  )}
                <img src={image} alt="img" />
              </div>
            </div>
