      ...
      >
        <>
          <div className="d-flex align-items-center">
            <Link style={{ margin: "0px 0px 8px 0px" }} to="/">
            ...
            </div>
            {
              userId && toggleProfile && (
                <div className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                  ...
                  <button className="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0"><Link to={`/StaffProfiles/staffProfile/`}>Profile</Link></button>
